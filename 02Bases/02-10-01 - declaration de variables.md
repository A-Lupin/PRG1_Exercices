...
4. Non ce n'est pas correct. Compile, mais la variable `n` n'est pas initialisé (et a une valeur indéfinie)
5. `m = 49`
6. Non ce n'est pas correct. La variable `nb_produit` est définie comme **const** et ne peux pas être modifiée `nb_produit--`.
